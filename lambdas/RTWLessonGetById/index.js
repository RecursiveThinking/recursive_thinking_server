...
exports.LessonGetById = (event, context, callback) => {
  ...
  dynamodb.get(params, function(err, lesson){
    if(err){
      ...
      console.log('err @ LessonGetById', err)
      callback(err)
    } else {
      let response = {};
      console.log('lessonById: ', lesson)
      console.log('lessonById: ', lesson.Item)
      response.statusCode = 200;
      response.body = JSON.stringify(lesson);
      response.headers = {
